...
**Note:** RSA-2048 is the default key type, matching fastcert's behavior. Use `--ecdsa` for ECDSA P-256 keys if needed.
...
Both RSA and ECDSA are fully supported. RSA is the default to match fastcert's behavior.
...
- Default matches fastcert behavior
